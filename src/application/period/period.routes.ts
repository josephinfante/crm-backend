...
periodRouter.get("/v1/periods/:business_unit_id", Access.canRead(['period', 'opportunity']), periodController.findByBusinessUnitId.bind(periodController));
periodRouter.get("/v1/periods", Access.canRead(['period', 'opportunity']), periodController.findAll.bind(periodController));
